...
export default function Slider() {
  ...
  return (
    ...
    <div className={styles['content-header']}>Check out what’s new at Gameloft! Deep dive into the latest news on your <br></br>favorite games, as well as stories from Gamelofters all over the world.</div>
      <Swiper
        cssMode={true}
        navigation={true}
        spaceBetween={30}
            ...
            <SwiperSlide key={i} className={styles["wiper-slide"]}>
              ...
              <div className={styles["wiper-slide_wrapper"]}>
                ...
                <div className={styles["wiper-slide_wrapper-footer"]}>
                  <button className={styles["wiper-slide_wrapper-footer__btn"]}>
                    Read More
                  </button>
                </div>
              </div>
